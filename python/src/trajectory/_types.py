...
TrajectorySource = Literal[
    "atif", "claude-code", "codex", "copilot-cli", "cursor", "droid", "gemini-cli", "hermes", "letta-code", "omp", "openclaw", "opencode", "openhands", "pi", "prime"
]
CheckpointTrajectorySource = Literal["deepagents"]
AnyTrajectorySource = Literal[
    "atif", "claude-code", "codex", "copilot-cli", "cursor", "droid", "gemini-cli", "hermes", "letta-code", "omp", "openclaw", "opencode", "openhands", "pi", "prime", "deepagents"
]
