...
The physical JSONL row shapes, ordering, packed `reasoning-chunks`, event
...
attachments, response IDs, message IDs, and RPC IDs are replaced. The source
artifact itself is not distributed because it contains private user content.
